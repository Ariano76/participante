...
<h1 class="display-8">BONO FAMILIAR</h1> 
<br>
<div class="container">
...
<script type="text/javascript">
  $(document).ready(function() {
    $('#tablaUsuarios').DataTable({
      ...
      'order': [],
      'ajax': {
        'url': 'bono_familiar_fetch_data.php',
        'type': 'post',
      },
      "aoColumnDefs": [{
        "bSortable": false,
  ...
  $('#tablaUsuarios').on('click', '.editbtn ', function(event) {
    ...
    var trid = $(this).closest('tr').attr('id');
      ...
      $.ajax({
        url: "bono_familiar_get_single.php",
        data: {
          id: id
        },
        type: 'post',
          ...
          <form id="updateUser">
            ...
            <div class="mb-3 row">
              ...
              <div class="md-form amber-textarea active-amber-textarea col-md-6">
                <input step="0.10" type="number" class="form-control" id="asignacionField" name="tipoident" maxlength="6" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
              </div>
            </div>
        ...
        <div class="modal-body">
          <form id="addUser" action="">
            <div class="mb-3 row">
              ...
              <div class="col-md-6">
                <input step="0.01" type="number" class="form-control" id="addasignacionField" name="tipoident" maxlength="5">
              </div>
            </div>
            <div class="text-center">
